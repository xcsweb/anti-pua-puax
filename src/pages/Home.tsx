...
export default function Home({ mode = 'romance' }: HomeProps) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[80vh] overflow-hidden w-full">
      ...
      {/* Main Content */}
      <div className="z-10 flex flex-col items-center gap-4 sm:gap-8 text-center px-2 sm:px-4 w-full">
        <motion.div
        ...
        >
          ...
          <div className="w-full max-w-2xl mx-auto">
            {mode === 'romance' && (
              <div className="card-brutal bg-white p-4 sm:p-8 flex flex-col items-center justify-between border-[4px] border-black shadow-[4px_4px_0px_#000] sm:shadow-[8px_8px_0px_#000]">
                <div className="flex flex-col items-center mb-6 text-center">
                  <Heart size={40} className="text-[#f9a8d4] mb-4 sm:w-12 sm:h-12" strokeWidth={3} />
                  <h2 className="text-2xl sm:text-3xl font-black mb-2">赛博恋爱段位测试</h2>
                  <p className="text-base sm:text-lg font-bold text-gray-700">专注情感领域，测试你的恋爱防线</p>
                  <p className="text-xs sm:text-sm font-bold text-red-500 mt-2">（请选择性别以进入对应的沉浸式场景）</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                  <motion.button
                    ...
                    className="btn-brutal bg-[#f9a8d4] text-lg sm:text-xl w-full py-3 px-6 flex-1 flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <motion.button
                    ...
                    className="btn-brutal bg-[#93c5fd] text-lg sm:text-xl w-full py-3 px-6 flex-1 flex items-center justify-center gap-2 cursor-pointer"
                  >
            ...
            {mode === 'full' && (
              <div className="card-brutal bg-white p-4 sm:p-8 flex flex-col items-center justify-between border-[4px] border-black shadow-[4px_4px_0px_#000] sm:shadow-[8px_8px_0px_#000]">
                <div className="flex flex-col items-center mb-6 text-center">
                  <ShieldAlert size={40} className="text-[#fde047] mb-4 sm:w-12 sm:h-12" strokeWidth={3} />
                  <h2 className="text-2xl sm:text-3xl font-black mb-2">全景防PUA综合测试</h2>
                  <p className="text-base sm:text-lg font-bold text-gray-700">职场、家庭、社交全方位极限施压</p>
                </div>
                <motion.button
                  whileHover={{ scale: 1.05, rotate: 1 }}
                  whileTap={{ scale: 0.95, rotate: 0 }}
                  onClick={handleStartFull}
                  className="btn-brutal bg-[#4ade80] text-xl sm:text-2xl py-3 sm:py-4 px-4 sm:px-8 w-full flex items-center justify-center gap-3 cursor-pointer mt-auto"
                >
          ...
          <div className="mt-8 sm:mt-12 flex flex-col items-center gap-4 sm:gap-6 w-full">
            <motion.button
              ...
              className="btn-brutal bg-white text-lg sm:text-xl py-3 px-4 sm:px-8 w-full sm:w-auto flex items-center justify-center gap-3 cursor-pointer shadow-[4px_4px_0px_#000] border-[4px] border-black font-black"
            >
              <BookOpen size={24} strokeWidth={3} />
              查看{mode === 'romance' ? '恋爱' : '全景'}图鉴
            </motion.button>
            <p className="text-xs sm:text-sm font-bold text-gray-700 opacity-80">本测试仅供娱乐，请勿当真</p>
          </div>
        </motion.div>
      </div>
    </div>
